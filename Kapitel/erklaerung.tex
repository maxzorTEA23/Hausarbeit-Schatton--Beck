...
Wir versichern hiermit, dass wir unsere Hausarbeit mit dem Thema:

\begin{quote}
	\textit{Integration einer automatisierten Verpackungsanlage von Bremssystemen} % -\textit{ \untertitel }
\end{quote}
